function FBP = fbpSimData(nFWPTtotal,RS,CTAC,wcc,vox)
%"fbpSimData"
%   Reconstructs PET-like images via FBP
%
% CRS, 08/01/2013
%
%Usage: 
%   [FBP] = fbpSimData(nFWPTtotal,RS,CTAC,POST,wcc,radBin,tanBin,simSize,zSlice)
...
for i = 1:vox.petOut.rtz(3)
    ...
    if (OddMat)
        ...
        FBP(:,:,i) = imresize(disk.*f(:,:,i)/wcc,size(f(:,:,i))-1);
    end
