function OS = osemPSFSimData(nFWPTtotal,RS,CTAC,initPT,PSF, ...
...
%
%Usage:
%   [OSpsf] = mlemPSFSimData(nFWPTtotal,RS,CTAC,PSF,POST,wcc,radBin,tanBin,simSize,zSlice,iterNUM,reconType)
