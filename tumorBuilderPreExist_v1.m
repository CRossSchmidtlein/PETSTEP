function [FBP,OS,OSpsf] = tumorBuilderPreExist_v1(planC,simX);
%"tumorBuild_v1"
...
simSize    = simX.simSize;         % Odd Matrix size of reconstructed image
% zFilter -> Heavy[ 1 2 1]/4, Standard[1 4 1]/6, Light[1 6 1]/8, None[0 1 0]
...
getSimImages(CTscanNum,refCT,'CT + Tumor',zSlices,1);  drawnow
