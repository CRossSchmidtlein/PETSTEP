function [FBP,OS,OSpsf] = tumorBuilderObject_v1_dynamic(planC,simX)
%"tumorBuild_v1"
...
% inserts tumor either additively or by voxel replacement
...
%         if (max(FBP(:)) > 0), getSimImages(PTscanNum,FBP(:,:,:,i),fbpName,zSlices,1,simX);drawnow; end
